...
class Responder {
    ...
    public String generateResponse(String input) {
        if (input.toLowerCase().contains("cuaca")) {
            if(flag==1){
                // continue;
                return "Cuaca hari ini adalah: " + this.weather + ". Rekomendasi pakaian: " + this.clothingRecommendation;
            }
            else{
                ...
                return "Cuaca hari ini adalah: " + weather + ". Rekomendasi pakaian: " + clothingRecommendation;
            }
        } else {
